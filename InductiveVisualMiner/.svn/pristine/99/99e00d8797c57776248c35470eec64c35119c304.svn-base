...
/*
 * Copyright 1997-2006 Sun Microsystems, Inc. All Rights Reserved. DO NOT ALTER
 ...
 */
public class GuaranteedProgressMonitor extends Object implements Accessible {
	 ...
	 * @see JOptionPane
	 */
	public GuaranteedProgressMonitor(Component parentComponent, Object message, String note, int min, int max) {
		this.min = min;
		this.max = max;
	...
	private class ProgressOptionPane extends JOptionPane {
		...
		private static final long serialVersionUID = 413857155845539405L;

		ProgressOptionPane(Object messageList) {
			super(messageList, JOptionPane.INFORMATION_MESSAGE, JOptionPane.DEFAULT_OPTION, null,
					GuaranteedProgressMonitor.this.cancelOption, null);
		}
		...
		public JDialog createDialog(Component parentComponent, String title) {
			...
			Window window = findWindow(parentComponent);
		...
		public AccessibleContext getAccessibleContext() {
			return GuaranteedProgressMonitor.this.getAccessibleContext();
		}
