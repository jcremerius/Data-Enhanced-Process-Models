...
public class IvMObject<C> {
	...
	public static final IvMObject<String> boah = c("histogram width", String.class);
	//public static final IvMObject<HashMap> activity_attributes = c("activity_attributes", HashMap.class);
	//computed objects
