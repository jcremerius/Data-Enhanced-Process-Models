...
public class DfgTokeniser {
	 ...
	 */
	@Deprecated
	public DfgTokeniser(InputStream is) {
		this();
		if (is == null) {
	...
	public String toString() {
		...
		switch (ttype) {
			...
			default : {
				 ...
				 * an ordinary character. ttype can definitely not be less than
				 * 0, since those are reserved values used in the previous case
				 * statements
				 */
